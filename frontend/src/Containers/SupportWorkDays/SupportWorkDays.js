...
const SupportWorkDays = () => {
    ...
    const selectChangeHandler = async (e, day, date) => {
        const hoursValue = convertCalendarValueToWorkDayTime(userRoles.supports, parseFloat(e.target.value));
...
export default SupportWorkDays;